...
(	
	...
	Flag				int					NOT NULL	CONSTRAINT	DF_sdJobLogTasks_Flag			DEFAULT(0)								,	--тип действия 0- уменьшить время автоматически, 1- установить время в ручную
	SetTime				int					NOT NULL	CONSTRAINT	DF_sdJobLogTasks_SetTime		DEFAULT(0)								,	--оставшеся время в минутах
